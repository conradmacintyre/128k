...
<html>
	...
	<body>
		...
		<div class="billboard">
			<div class="billboard-slide active" data-ci="_images/billboard-coffee.jpg">
		...
		<section class="blog" id="blog">
			...
			<div class="slant-tile left" data-ci="_images/placeholder.jpg">
				<div class="internal">
					<div class="image"></div>
		...
		<section class="design-thoughts" id="design">
			<div class="text-section">
				...
				<img data-ci="_images/ipod-mini.jpg" alt="" class="float:left">
		...
		<section class="about-me" id="about">
			...
			<div class="slant-tile right" data-ci="_images/conrad.jpg">
				<div class="internal">
					<div class="image"></div>
					<div class="text">
						...
						<div id="calvin-meme" class="popup-content">
							<img data-ci="_images/calvin-meme.jpg" alt="">
						</div>
		...
		<div class="billboard">
			<div class="billboard-slide active" data-ci="_images/billboard-conrad.jpg">
			...
			<div class="clients-inner">
				<div class="client">
					<a href="https://www.bernardin.ca/" target="blank" class="popup-link_" data-content="bernardin">
						<span class="logo" data-ci="_images/logo-bernardin.png"></span>
						<span>Bernardin</span>
					</a>
				</div>
		...
		<section class="projects">
			...
			<div class="project-cards">
				...
				<a href="/blackjack" class="project-card tag-game" data-ci="_images/project-blackjack.jpg" data-ci-type="height">
				...
				<a href="/brandwars" class="project-card tag-game" data-ci="_images/project-brandwars.jpg" data-ci-type="height">
				...
				<a href="/dgr" class="project-card tag-game" data-ci="_images/project-dgrbingo.jpg" data-ci-type="height">
				...
				<a href="/jeopardy" class="project-card tag-game" data-ci="_images/project-jeopardy.jpg" data-ci-type="height">
