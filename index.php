	...
	<body>
		...
		<section class="clients">
			...
			<div class="clients-inner">
				...
				<div class="client">
					<a href="#">
						<span class="logo" data-bgimg="_images/logo-bodymods.jpg"></span>
						<span>Body Mods</span>
					</a>
				</div>
				<div class="client">
				...
				<div class="client">
					<a href="#">
						<span class="logo" data-bgimg="_images/logo-fitnesstown.jpg"></span>
		...
		<section class="projects" id="projects">
			...
			<div class="project-cards">
				...
				<a href="/fanedits/shining.php" class="project-card tag-video" data-bgimg="_images/project-stand.jpg">
				...
				<a href="/wheel-of-fortune" class="project-card tag-game" data-bgimg="_images/project-wheel.jpg">
					<h3 class="title">Wheel of Fortune (Beta)</h3>
					<span class="image"></span>
					<p class="description">As a youth pastor I needed to make some games that could be played by a fairly large group in a fairly small space. Game shows seemed like a great option. So I threw this together. Currently they have no documentation, but I'll work on that. In the meantime, feel free to poke around.</p>
				</a>
				<a href="https://youtube.com/user/conradmacintyre" class="project-card tag-video" data-bgimg="_images/project-youtube.png">
		...
		<!-- Back to top -->
		<a href="jacascript:void(0);" class="backtotop">HOWDY PILGRIM</a>
